...
```csv
run_id,timestamp,model_name,task,backend,device,batch_size,warmup_runs,max_steps,Total Samples,Top-1 Accuracy,Top-5 Accuracy,Average Latency (ms),P99 Latency (ms),accuracy,MAE,MSE,RMSE
a1b2c3d4,2026-04-10 14:30:00,resnet50,IMAGE_CLASSIFICATION,onnxruntime,cuda,1,2,,5000,75.42,92.18,12.34,15.67,,,,
e5f6g7h8,2026-04-10 15:00:00,bert-base-uncased,NLP_CLASSIFICATION,onnxruntime,cpu,1,2,,1000,,,8.45,10.23,92.5,,,
```
